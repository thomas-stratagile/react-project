...
const Twssection = () => {
    return (
        <>
            ...
            <div className='flex lg:flex-row flex-col lg:justify-between gap-10 min-h-screen items-center bg-gradient-to-b from-cyan-50 to-slate-100 py-10'>
